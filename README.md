...
r = RobotPost(r"""Doosan""",r"""Doosan M1013""",6, axes_type=['R','R','R','R','R','R'], ip_com=r"""127.0.0.1""", api_port=20500, prog_ptr=2010448978912, robot_ptr=2010450050608)

r.ProgStart(r"""Prog1""")
r.RunMessage(r"""Program generated by RoboDK v5.5.0 for Doosan M1013 on 10/11/2022 10:19:02""",True)
r.RunMessage(r"""Using nominal kinematics.""",True)
r.setFrame(p(430.268,-280,-23.4017,0,-0.656408,0),-1,r"""Path_1""")
r.setTool(p(0,0,130,0,0,0),-1,r"""Set Tool: RobotiQ 2F-85 Gripper (Open)""")
r.MoveJ(p(-377.631,220.053,752.045,-103.177,-20.1153,-127.534),[-31.31,-55.38,114.4,3.22,65.38,-117.76],[1,0,0])
r.MoveJ(p(5.05274,-15.0688,420.897,-95.0156,3.60096,178.557),[-31.316,2.57914,114.401,3.22019,65.3864,-117.769],[0,0,0])
r.MoveL(p(-1.36621,6.13461,94.176,-95.0156,3.60096,178.557),[-30.2,15,125.31,4.44,42.05,-118.61],[0,0,0])
r.RunMessage(r"""Attach to RobotiQ 2F-85 Gripper (Open)""",True)
r.MoveL(p(20.2536,516.716,93.9283,-34.5997,4.19851,178.838),[30.2,15,125.31,4.44,42.05,-118.61],[0,0,0])
r.RunMessage(r"""Detach from RobotiQ 2F-85 Gripper (Open)""",True)
r.ProgFinish(r"""Prog1""")
r.ProgSave(r"""C:/Users/sanjna priya saran/Documents/RoboDK/""",r"""Prog1""",False,r"""E:/RoboDK/Other/VSCodium/VSCodium.exe""")
...
![4 3](https://user-images.githubusercontent.com/75234965/201004027-fbddcc9f-3b52-4733-b482-07c051a8021e.png)
